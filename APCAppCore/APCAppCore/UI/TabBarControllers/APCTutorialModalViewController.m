...
- (NSString *)getTextWithKey:(NSString *)key {
	...
	if ([key isEqualToString:kTutorialTextInitial]) {
		...
		text = NSLocalizedStringWithDefaultValue(@"You will find your list of daily surveys and tasks on the \"Activities\" tab. New surveys and tasks will appear over the next few weeks.\n\nPlease perform these activities each day when you are at your lowest before you take your Parkinson medications, after your medications take effect, and then a third time during the day.", @"APCAppCore", APCBundle(), @"You will find your list of daily surveys and tasks on the \"Activities\" tab. New surveys and tasks will appear over the next few weeks.\n\nPlease perform these activities each day when you are at your lowest before you take your Parkinson medications, after your medications take effect, and then a third time during the day.", nil);
